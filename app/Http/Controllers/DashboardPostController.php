...
class DashboardPostController extends Controller
{
    ...
    public function update(Request $request, Post $post)
    {
        ...
        //memvalidasi slug agar walau slug user tidak berubah saat di edit(karena dia unique), dengan ini masih bisa kekirim. tanpa ini edit tidak bisa kekirim (warning! slug has already taken)
